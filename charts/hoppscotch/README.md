...
![AppVersion: 2025.6.0](https://img.shields.io/badge/AppVersion-2025.6.0-informational?style=flat-square)
...
| aio.livenessProbe                                 | object | `{}`                                | Configure Hoppscotch liveness probe                                                                                  |
| aio.readinessProbe                                | object | `{}`                                | Configure Hoppscotch readiness probe                                                                                 |
...
| aio.updateStrategy.rollingUpdate                  | object | `{"maxSurge":1,"maxUnavailable":1}` | Rolling update configuration parameters                                                                              |
| aio.updateStrategy.rollingUpdate.maxUnavailable   | int    | `1`                                 | Maximum number of pods that can be unavailable during the update                                                     |
| aio.updateStrategy.rollingUpdate.maxSurge         | int    | `1`                                 | Maximum number of pods that can be created above the desired number of pods                                          |
...
| aio.ingress.hostname                              | string | `"hoppscotch-frontend.local"`       | Ingress hostname                                                                                                     |
...
| frontend.livenessProbe                                 | object | `{}`                                | Configure Hoppscotch liveness probe                                                                                  |
| frontend.readinessProbe                                | object | `{}`                                | Configure Hoppscotch readiness probe                                                                                 |
...
| frontend.updateStrategy.rollingUpdate                  | object | `{"maxSurge":1,"maxUnavailable":1}` | Rolling update configuration parameters                                                                              |
| frontend.updateStrategy.rollingUpdate.maxUnavailable   | int    | `1`                                 | Maximum number of pods that can be unavailable during the update                                                     |
| frontend.updateStrategy.rollingUpdate.maxSurge         | int    | `1`                                 | Maximum number of pods that can be created above the desired number of pods                                          |
...
| backend.livenessProbe                                 | object | `{}`                                | Configure Hoppscotch liveness probe                                                                                  |
| backend.readinessProbe                                | object | `{}`                                | Configure Hoppscotch readiness probe                                                                                 |
...
| backend.updateStrategy.rollingUpdate                  | object | `{"maxSurge":1,"maxUnavailable":1}` | Rolling update configuration parameters                                                                              |
| backend.updateStrategy.rollingUpdate.maxUnavailable   | int    | `1`                                 | Maximum number of pods that can be unavailable during the update                                                     |
| backend.updateStrategy.rollingUpdate.maxSurge         | int    | `1`                                 | Maximum number of pods that can be created above the desired number of pods                                          |
...
| admin.livenessProbe                                 | object | `{}`                                | Configure Hoppscotch liveness probe                                                                                  |
| admin.readinessProbe                                | object | `{}`                                | Configure Hoppscotch readiness probe                                                                                 |
...
| admin.updateStrategy.rollingUpdate                  | object | `{"maxSurge":1,"maxUnavailable":1}` | Rolling update configuration parameters                                                                              |
| admin.updateStrategy.rollingUpdate.maxUnavailable   | int    | `1`                                 | Maximum number of pods that can be unavailable during the update                                                     |
| admin.updateStrategy.rollingUpdate.maxSurge         | int    | `1`                                 | Maximum number of pods that can be created above the desired number of pods                                          |
...
| defaultInitContainers.waitForDatabaseMigrations.enabled | bool | `true`  | Enable init container that waits for database migrations to complete |
